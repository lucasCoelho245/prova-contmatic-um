...
public class AuditoriaConstants {
    ...
    public static final String LOG_CRIACAO_INVALIDA = "a data do campo data criacao em auditoria esta com ano invalido";
    ...
    public static final String LOG_LOGOUT_INVALIDA = "a data do campo data logout em auditoria esta com ano invalido";
