...
public class CargoConstants {
    ...
    public static final String TAMANHO_DE_CARGO_ESTÁ_ABAIXO_DE_2_CARACTERES = ("Tamanho de string nome em cargo está abaixo de 2 caracteres");
    public static final String TAMANHO_DE_CARGO_ESTÁ_ACIMA_DE_60_CARACTERES = ("Tamanho de string nome em cargo está acima de 60 caracteres");
    ...
    public static final String TAMANHO_DE_SETOR_DE_CARGO_ESTÁ_ACIMA_DE_30_CARACTERES = ("Tamanho de string setorCargo em cargo está acima de 30 caracteres");
    public static final String CODIGO_DE_CARGO_ESTA_NULO = ("Codigo em cargo não pode ser nulo ");
    public static final String TAMANHO_DE_CODIGO_ESTÁ_ABAIXO_DE_2_CARACTERES = ("Tamanho de string Codigo em cargo está abaixo de 2 caracteres");
